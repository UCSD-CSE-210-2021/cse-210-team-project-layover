...
if __name__ == '__main__':
	...
	myMeeting = LayoverMeeting(
		meeting_id, name, meeting_type, meeting_length, date_type, start_date, end_date)
	...
	num_days = 7
	num_blocks_in_day = int((day_end_time - day_start_time)
							* (60 / myMeeting.meeting_length))
	...
	user1.setAvailability(inPersonAvailability=avail_1,
						  virtualAvailability=avail_1)
	user2.setAvailability(inPersonAvailability=avail_2,
						  virtualAvailability=avail_2)
	user3.setAvailability(inPersonAvailability=avail_3,
						  virtualAvailability=avail_3)
	user4.setAvailability(inPersonAvailability=avail_4,
						  virtualAvailability=avail_4)
	user5.setAvailability(inPersonAvailability=avail_5,
						  virtualAvailability=avail_5)
